package com.quannm18.coolmateapp.utils.zalopay.Api;

import com.quannm18.coolmateapp.utils.zalopay.AppInfo;
import com.quannm18.coolmateapp.utils.zalopay.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            AppId = String.valueOf(AppInfo.Companion.getAPP_ID());
            ...
            Mac = Helpers.getMac(AppInfo.Companion.getMAC_KEY(), inputHMac);
        }
    }
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = HttpProvider.sendPost(AppInfo.Companion.getURL_CREATE_ORDER(), formBody);
        return data;
    }
}
